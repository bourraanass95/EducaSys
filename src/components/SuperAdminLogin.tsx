...
export const SuperAdminLogin = ({ onLogin }: SuperAdminLoginProps) => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6 bg-[grid-white-5] relative overflow-hidden">
      <div className="absolute inset-0 bg-blue-500/10 blur-[120px] -z-10 rounded-full scale-50" />
      
      <Link 
        to="/"
        className="absolute top-8 left-8 flex items-center gap-2 text-xs font-black uppercase tracking-widest text-gray-500 hover:text-blue-500 transition-colors group"
      >
      ...
      >
        <div className="text-center mb-10">
           ...
           <h1 className="text-3xl font-black text-white uppercase italic tracking-tighter">Nexus <span className="text-blue-500">Core</span></h1>
           <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.3em] mt-2">Global SaaS Administration</p>
        </div>

        <div className="bg-gray-900/50 backdrop-blur-xl border border-white/5 p-10 rounded-[40px] shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white/5 border border-white/5 focus:border-blue-500/50 rounded-2xl text-white text-sm outline-none transition-all font-medium"
            ...
            {error && (
              <motion.p 
                ...
                className="text-red-400 text-xs font-bold bg-red-400/10 p-4 rounded-xl border border-red-400/20"
              >
                {error}
              </motion.p>
            )}
            ...
            <button
              ...
              className="w-full py-3 bg-white/5 hover:bg-white/10 text-gray-400 rounded-xl text-[10px] font-black uppercase italic tracking-widest transition-all border border-white/5 mt-2"
            >
